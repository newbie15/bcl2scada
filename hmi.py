...
def awal():
    system('cls')
    print " ____    _____  _        ___             _    _  __  __  _____                  _         _                 "
    print "|  _ \  / ____|| |      |__ \           | |  | ||  \/  ||_   _|                (_)       | |                "
    print "| |_) || |     | |         ) |  ______  | |__| || \  / |  | |   __      __ ___  _   __ _ | |__    ___  _ __ "
    print "|  _ < | |     | |        / /  |______| |  __  || |\/| |  | |   \ \ /\ / // _ \| | / _` || '_ \  / _ \| '__|"
    print "| |_) || |____ | |____   / /_           | |  | || |  | | _| |_   \ V  V /|  __/| || (_| || | | ||  __/| |   "
    print "|____/  \_____||______| |____|          |_|  |_||_|  |_||_____|   \_/\_/  \___||_| \__, ||_| |_| \___||_|   "
    print "                                                                                    __/ |                   "
    print "                                                                                    |___/                   "
    print ""
    print ""
    ...
    print ""
    print "   1. Ubah Rate (Ton/Jam)"
    print "   2. Ubah Ratio Material"
    print "   "
    print "   x. Ubah Weighing Length"
    # print "   3. Ubah Freq Motor"
    print ""
    print ""
    # print "apa yang ingin anda lakukan ?"
    name = raw_input("apa yang ingin anda lakukan ? : ")
    print name
    ...
    if name == "1" :
        ...
        hopper = raw_input("--hopper no berapa yang anda ingin rubah ? : ")
        ratio = raw_input("----masukkan nilai persentase ratio yang baru : ")
        fratio(hopper,ratio)
        selesai()

    elif name == "x" :
        belt = raw_input("--hopper / belt no berapa yang anda ingin rubah ? : ")
        value = raw_input("----masukkan nilai weighing length yang baru : ")
        wlength(belt,value)
        selesai()
