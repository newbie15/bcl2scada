...
Adafruit_MCP4725 dac1(INV1); // constructor
Adafruit_MCP4725 dac2(INV2); // constructor
Adafruit_MCP4725 dac3(INV3); // constructor
Adafruit_MCP4725 dac4(INV4); // constructor
Adafruit_MCP4725 dac5(INV5); // constructor
Adafruit_MCP4725 dac6(INV6); // constructor
Adafruit_MCP4725 dac7(INV7); // constructor
...
//  }
  ...
  dac_value1 = 4095 * (volt_target[0]/5.0);
//  dac_value2 = 4096 * (volt_target[1]/5.0);
  dac_value3 = 4095 * (volt_target[2]/5.0);
  dac_value4 = 4095 * (volt_target[3]/5.0);
  dac_value5 = 4095 * (volt_target[4]/5.0);
  dac_value6 = 4095 * (volt_target[5]/5.0);
  dac_value7 = 4095 * (volt_target[6]/5.0);
