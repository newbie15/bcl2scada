...
//			t1.Start();
		...
		void serial_command(){
			...
			String z1 = (float.Parse(f1.Text)/10).ToString();
			String z2 = (float.Parse(f2.Text)/10).ToString();
			String z3 = (float.Parse(f3.Text)/10).ToString();
			String z4 = (float.Parse(f4.Text)/10).ToString();
			String z5 = (float.Parse(f5.Text)/10).ToString();
			String z6 = (float.Parse(f6.Text)/10).ToString();
			String z7 = (float.Parse(f7.Text)/10).ToString();
						
			serialPort1.Write(z1+";"+z2+";"+z3+";"+z4+";"+z5+";"+z6+";"+z7+"*");
		}
